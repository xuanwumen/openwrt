...
KERNEL_VERSION="5.9.8-flippy-49+"
SUBVER=$1
# Armbian
...
# 目标镜像文件
TGT_IMG="${WORK_DIR}/S905x3_49+_Openwrt.img"
...
# 用于 X96 Max+ (S905X3 网卡工作于 1000M) (超频至2244Mhz)
...
if [ -f lib/firmware/brcm/brcmfmac4339-sdio.ZP.txt ];then
    ( 
      cd lib/firmware/brcm  &&
      ln -s brcmfmac4339-sdio.ZP.txt brcmfmac4339-sdio.amlogic,sm1.txt
    )
fi
