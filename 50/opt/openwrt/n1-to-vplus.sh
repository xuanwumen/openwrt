...
#KERNEL_VER=5.4.77-flippy-49+o
KERNEL_VER=5.4.80-flippy-50+o

SRC=$WORKDIR/tmp/N1_Openwrt_${OPENWRT_VER}_k${KERNEL_VER}.img
DST=$WORKDIR/tmp/VPlus_Openwrt_${OPENWRT_VER}_k${KERNEL_VER}.img
